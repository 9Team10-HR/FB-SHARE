# Gift By : Md HR 
# Github : https://github.com/9Team10-HR
# Fb Id    : Ewr Crush King
###----------[ IMPORT LIBRARY ]---------- ###
...
def logo_menu():
 ...
 /_/ \_\___/  |_| \___/  |___/_||_/_/ \_\_|_\___|'''
    cetak(
        nel(banner, title=f'{P2} {K2}[ {H2}M{H2}D{H2}:{H2}H{H2}R{H2} {B2}A{B2}U{B2}T{B2}O {K2}S{K2}H{K2}A{K2}R{K2}E {H2}]',
...
def login():
    ...
    ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
    \33[1;32m====================================================
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;92mMD:HR
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;93mEwr Crush King(HR)
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;94m9Team10-HR
    ...
    cetak(nel(f'\n \t {H2}  FB AUTO SHARE TOOLS BRO \n\n \t\t {H2}~[{K2} T{K2}A{K2}S{K2}L{K2}I{K2}M {H2}]~',
              title=f'{P2}  {H2}[{K2} M{K2}D{K2}:{K2}H{K2}R{K2} {K2}T{K2}E{K2}R{K2}M{K2}U{K2}X {K2}H{K2}E{K2}L{K2}P{K2}I{K2}N{K2}G {K2}Z{K2}O{K2}N{K2}E {H2}]',
...
{B2} Current Date    :{H2} {hari}, {tanggal}''', title=f'{P2} {H2}[ {K2}Cookie Id Information {H2}]',
    ...
    cetak(
        nel(f'{H2} M{H2}D{H2}:{H2}H{H2}R{H2} {B2}F{B2}B {O2}A{O2}U{O2}T{O2}O {N2}S{N2}H{N2}A{N2}R{N2}E {K2}S{K2}T{K2}A{K2}R{K2}T',
    ...
    try:
        ...
        for x in range(jumlah):
            ...
            if "id" in post:
                ...
                print(f'{P}\r   └──>{H} {bas} {K} M{K}D{K}:{K}H{K}R{K}  SEND {H}[{n}]{P}{K} AUTO SHARE {H} SUCSSES{H} ',
                      end='');
                sys.stdout.flush()
            else:
                print("\n")
